 ...
 * speexdsp out the {@link OpusPacket} sink, inbound packets decode onto
 * {@link ActiveCall#remoteAudioSource()}, VAD populates the voice-active flag, and the pipeline
 * survives malformed input and idempotent close. Tests drive the pipeline with synthesised sine
 * frames at the 160-sample 10 ms / 16 kHz WhatsApp voice profile.
 */
