 ...
 */
public sealed interface SmaxPassiveModePassiveIQResponse extends SmaxStanza.Response
    ...
    static Optional<? extends SmaxPassiveModePassiveIQResponse> of(Stanza stanza, Stanza request) {
    ...
    final class Success implements SmaxPassiveModePassiveIQResponse {
        ...
        public static Optional<Success> of(Stanza stanza, Stanza request) {
            ...
            if (stanza.getChild("passive").isEmpty()) {
                return Optional.empty();
            }
