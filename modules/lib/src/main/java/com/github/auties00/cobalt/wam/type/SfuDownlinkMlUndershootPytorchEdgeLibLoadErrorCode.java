...
@WhatsAppWebModule(moduleName = "WAWebWamEnumSfuDownlinkMlUndershootPytorchEdgeLibLoadErrorCode")
@WamEnum
public enum SfuDownlinkMlUndershootPytorchEdgeLibLoadErrorCode {
