...
/**
 * Parses the WhatsApp Web GraphQL response of the fetch-product-list query built by
 * {@link BizCatalogManagementFetchProductListWhatsAppGraphQlRequest} into a list of {@link BusinessProduct}.
 *
 ...
 *
 * @see BizCatalogManagementFetchProductListWhatsAppGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementFetchProductListQuery")
public final class BizCatalogManagementFetchProductListWhatsAppGraphQlResponse implements WhatsAppGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementFetchProductListWhatsAppGraphQlResponse(List<BusinessProduct> products) {
    ...
    public static Optional<BizCatalogManagementFetchProductListWhatsAppGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        return Optional.of(new BizCatalogManagementFetchProductListWhatsAppGraphQlResponse(products));
    }
