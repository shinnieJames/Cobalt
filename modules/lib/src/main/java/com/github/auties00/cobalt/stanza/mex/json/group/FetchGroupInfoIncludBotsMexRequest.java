 ...
 * {@link MexGroupQueryContext#UNKNOWN} (see {@link FetchGroupInfoMexRequest}).
 */
@WhatsAppWebModule(moduleName = "WAWebMexFetchGroupInfoIncludBotsJob")
public final class FetchGroupInfoIncludBotsMexRequest implements MexStanza.Request.Json {
    /**
    ...
    public static final String QUERY_ID = "26412593755077157";
     ...
     */
    public FetchGroupInfoIncludBotsMexRequest(String id, Boolean includeUsername, String participantsPhash, MexGroupQueryContext queryContext) {
        this.id = id;
