...
/**
 * Builds the relay query that fetches the eligible quick-promotion banners for a set of WhatsApp
 * Business surfaces.
 *
 ...
 * WhatsApp Web's {@code WAWebFetchQuickPromotions.fetchQuickPromotions()} fills it with the
 * {@code wa_smb_trigger_context} sub-object holding the {@code is_from_wa_smb} flag (set to
 * {@code true} on the Business build), the {@code app_version} base string, the caller's
 ...
 * surface-keyed batch under {@code quick_promotion_batch_fetch_root}; the reply is consumed through
 * {@link FetchQuickPromotionsWhatsAppGraphQlResponse}.
 *
 * @see FetchQuickPromotionsWhatsAppGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebFetchQuickPromotionsQuery")
public final class FetchQuickPromotionsWhatsAppGraphQlRequest implements WhatsAppGraphQlOperation.Request {
    /**
     ...
     */
    @WhatsAppWebExport(moduleName = "WAWebFetchQuickPromotionsQuery.graphql", exports = "params.id",
            adaptation = WhatsAppAdaptation.DIRECT)
    public static final String DOC_ID = "27262639366727460";
     ...
     */
    @WhatsAppWebExport(moduleName = "WAWebFetchQuickPromotionsQuery.graphql", exports = "params.name",
            adaptation = WhatsAppAdaptation.DIRECT)
    public static final String OPERATION_NAME = "WAWebFetchQuickPromotionsQuery";
    ...
    /**
     * Constructs a fetch-quick-promotions query request carrying the surface identifiers to evaluate
     ...
     */
    public FetchQuickPromotionsWhatsAppGraphQlRequest(List<String> nuxIds, TriggerContext triggerContext) {
        this.nuxIds = nuxIds;
     ...
     */
    @WhatsAppWebExport(moduleName = "WAWebFetchQuickPromotions", exports = "fetchQuickPromotions",
    ...
    public record TriggerContext(Boolean isFromWaSmb, String appVersion, String country, String locale) {
         ...
         *
         * <p>Reserved for {@link FetchQuickPromotionsWhatsAppGraphQlRequest#variables()}; writes each field only
