 ...
 * {@link #toDouble()}) so callers reading attributes through {@link Node} do
 * not need to switch on the underlying representation. Attribute values are
 * produced through {@link NodeBuilder} and consumed through the
...
public sealed interface NodeAttribute {
     ...
     *
     * <p>The default variant produced by {@link NodeBuilder}'s text, number,
    ...
    record TextAttribute(String value) implements NodeAttribute {
         ...
         *
         * <p>{@link NodeBuilder} and {@link Node}'s decoder path both ensure
         ...
         * {@code getAttributeAsJid} helpers on {@link Node} without wrapping
         * in a try/catch.
         *
     ...
     *
     * <p>Produced by {@link NodeBuilder#attribute(String, com.github.auties00.cobalt.model.jid.JidProvider)}
     * for any attribute referencing a WhatsApp user, group, device, or other
     * addressable entity, and by {@link Node}'s decoder when the wire shape is
     * one of {@link com.github.auties00.cobalt.node.binary.NodeTags#JID_PAIR},
     * {@link com.github.auties00.cobalt.node.binary.NodeTags#AD_JID},
     * {@link com.github.auties00.cobalt.node.binary.NodeTags#JID_INTEROP}, or
     ...
     *
     * <p>Produced by {@link Node}'s decoder when the wire shape is one of
     ...
     * {@link com.github.auties00.cobalt.node.binary.NodeTags#BINARY_32}, and
     * by {@link NodeBuilder#attribute(String, byte[])} for raw payloads
