...
/**
 * Builds the relay mutation that creates or onboards a WhatsApp Ads (WAA) ad account for a
 ...
 * milliseconds-since-epoch). The relay returns the newly created or onboarded ad account under
 * {@code create_or_onboard_wa_ad_account}; the reply is consumed through
 * {@link WaaOnboardingWhatsAppGraphQlResponse}.
 *
 * @see WaaOnboardingWhatsAppGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebWAAOnboardingMutation")
public final class WaaOnboardingWhatsAppGraphQlRequest implements WhatsAppGraphQlOperation.Request {
    /**
     ...
     *                  field
     */
    public WaaOnboardingWhatsAppGraphQlRequest(String flowId, Instant requestId) {
        this.flowId = flowId;
