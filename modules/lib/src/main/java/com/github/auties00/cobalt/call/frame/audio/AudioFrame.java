 ...
 * microphone, must downsample to 16 kHz mono before pushing into an {@link AudioSink}.
 *
 * @apiNote Implementations of {@link AudioSource} and {@link AudioSink} that capture or render at a
 * native rate other than 16 kHz mono are responsible for resampling; the call API does not
 * negotiate alternate formats and a mismatched rate is reproduced at the wrong pitch.
