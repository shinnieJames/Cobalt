 ...
 * or 32 bit length prefix. {@link NodeWriter} and {@link NodeReader} both
...
public final class NodeTags {
    ...
    /**
     * Tag byte that selects {@link NodeTokens#DICTIONARY_0_TOKENS} for the
     * next index byte.
     *
    ...
    /**
     * Tag byte that selects {@link NodeTokens#DICTIONARY_1_TOKENS} for the
     * next index byte.
     *
    ...
    /**
     * Tag byte that selects {@link NodeTokens#DICTIONARY_2_TOKENS} for the
     * next index byte.
     *
    ...
    /**
     * Tag byte that selects {@link NodeTokens#DICTIONARY_3_TOKENS} for the
     * next index byte.
     *
     ...
     *
     * <p>Appears at the top of every node (the size header that counts
     ...
     *
     * <p>Selected by {@link NodeWriter} when a node's size header or a child
     ...
     * Selected by {@link NodePackedFormat#getPackedType(String)} when a string
     ...
     * {@link NodeWriter} for any UTF-8-encoded string or raw byte blob shorter
     ...
     * {@link NodePackedFormat#getPackedType(String)} for numeric and
