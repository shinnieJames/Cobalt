 ...
 * ack the delivery. The {@link #raw()} accessor exposes the backing {@link Node} so callers can
...
public final class SmaxStatusDeliverIncomingNewsletterStatusResponse implements SmaxOperation.Response {
     ...
     *
     * <p>This constructor is invoked by {@link #of(Node)} after a successful parse and is not
     ...
     * @param raw             the underlying status node; never {@code null}
     ...
     *
     * <p>The format is intended for logging and is not part of any contract; the underlying node
