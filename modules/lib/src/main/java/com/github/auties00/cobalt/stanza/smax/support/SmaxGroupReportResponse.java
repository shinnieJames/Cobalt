 ...
 */
public sealed interface SmaxGroupReportResponse extends SmaxStanza.Response
    ...
    static Optional<? extends SmaxGroupReportResponse> of(Stanza stanza, Stanza request) {
