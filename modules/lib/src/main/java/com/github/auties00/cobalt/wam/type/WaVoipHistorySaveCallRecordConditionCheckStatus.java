...
@WhatsAppWebModule(moduleName = "WAWebWamEnumWaVoipHistorySaveCallRecordConditionCheckStatus")
@WamEnum
public enum WaVoipHistorySaveCallRecordConditionCheckStatus {
    @WamEnumConstant(0) INVALID,
    @WamEnumConstant(1) NOT_SINGLE_SEGMENT_CALL,
