 ...
 * inner payload itself is not modelled here: {@link #raw()} exposes the underlying {@link Node} so
...
public final class SmaxMessageDeliverNewsletterResponse implements SmaxOperation.Response {
    ...
    /**
     * Holds the optional {@code <meta><admin_profile/></meta>} child as a raw {@link Node} for
    ...
    /**
     * Holds the raw {@code <message>} {@link Node} backing this projection so callers can project the
     ...
     *
     * <p>This constructor is invoked by {@link #of(Node)} after a successful parse and is not intended
     ...
     * @param adminProfileMeta   the optional admin-profile child node; may be {@code null}
     ...
     * @param raw                the underlying message node; never {@code null}
     ...
     *
     * <p>The wrapped node is the raw {@code <meta><admin_profile/></meta>} child; callers project its
     * attributes as needed.
     *
     * @return an {@link Optional} carrying the node, or {@link Optional#empty()} when omitted
     */
    ...
    /**
     * Returns the underlying {@code <message>} {@link Node} so callers can project the variable-shape
     ...
     *
     * <p>The rcat bytes and underlying node are deliberately omitted to keep the result readable, and
