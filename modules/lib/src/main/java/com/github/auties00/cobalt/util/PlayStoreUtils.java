...
public final class PlayStoreUtils {
    /**
     * URL of the Aurora OSS anonymous token dispenser.
     */
    ...
    /**
     * Endpoint used to acquire a free application.
     */
    ...
    /**
     * Locale reported in {@code Accept-Language} and
     ...
     * @param deliveryResponse the delivery-response variant, or
     *     {@code null} for non-delivery responses
     */
    @ProtobufMessage
    record Payload(
