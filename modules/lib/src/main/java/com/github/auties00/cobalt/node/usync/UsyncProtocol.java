 ...
 * {@link UsyncQuery#parseResponse(Node)} can match per-user children.
 */
...
public sealed interface UsyncProtocol permits
     ...
     *
     * <p>Used by {@link UsyncQuery#parseResponse(Node)} to look up the matching
     ...
     * result.
     *
     * <p>Returns a {@link com.github.auties00.cobalt.node.usync.result.UsyncProtocolError}
     ...
     * {@link com.github.auties00.cobalt.node.usync.result.UsyncProtocolResponse}.
     *
     * @implSpec
     * Implementations must throw {@link IllegalStateException} when invoked on a
     * node whose tag is not {@link #name()}; this matches the tag-assertion
