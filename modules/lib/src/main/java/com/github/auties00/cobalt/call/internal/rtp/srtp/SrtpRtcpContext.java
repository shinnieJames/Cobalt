...
final class SrtpRtcpContext {
     ...
     * the packet.
     *
     * <p>The full 20-byte HMAC-SHA1 output is computed and the leading {@link #AUTH_TAG_LEN} bytes
     ...
     * {@code packet[0..authedLen)} into {@code packet[authedLen..authedLen + AUTH_TAG_LEN)}.
     *
