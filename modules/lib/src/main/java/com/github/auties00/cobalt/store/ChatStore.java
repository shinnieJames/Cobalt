...
public interface ChatStore {
     ...
     */
    ChatStore setFavoriteChats(List<Jid> favoriteChats);
     ...
     * @return this store instance for method chaining
     */
    ChatStore putNewsletterPin(NewsletterPin pin);
     ...
     * @return this store instance for method chaining
     */
    ChatStore addCallLog(CallLog callLog);
