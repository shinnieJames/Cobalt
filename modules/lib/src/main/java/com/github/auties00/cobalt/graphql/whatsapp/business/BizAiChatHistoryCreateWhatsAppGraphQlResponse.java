...
/**
 * Parses the WhatsApp Web GraphQL response of the create-chat-history mutation built by
 * {@link BizAiChatHistoryCreateWhatsAppGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiChatHistoryCreateWhatsAppGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiChatHistoryCreateMutation")
public final class BizAiChatHistoryCreateWhatsAppGraphQlResponse implements WhatsAppGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiChatHistoryCreateWhatsAppGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiChatHistoryCreateWhatsAppGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiChatHistoryCreateWhatsAppGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(Boolean.TRUE.equals(node.getBoolean("success")))
                .build();
        return Optional.of(new BizAiChatHistoryCreateWhatsAppGraphQlResponse(result));
    }
