...
public final class SmaxMdSetToCompanionResponse implements SmaxOperation.Response {
     ...
     *
     * <p>The domain is validated by {@link #of(Node)} during parsing, and the JID is echoed back
     ...
     *
     * <p>Contains exactly six entries when the projection was parsed by {@link #of(Node)};
