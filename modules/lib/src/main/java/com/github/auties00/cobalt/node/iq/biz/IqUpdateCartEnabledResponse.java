...
public sealed interface IqUpdateCartEnabledResponse extends IqOperation.Response
    ...
    final class Success implements IqUpdateCartEnabledResponse {
        ...
        /**
         * Constructs a success reply from the post-mutation flag; called from {@link #of(Node, Node)}.
         *
         ...
         * flag from {@code <commerce_settings><cart enabled/>}; called from {@link #of(Node, Node)}.
         *
         * @implNote
