 ...
 * {@link NodeWriter} emits is first looked up in these tables. A hit in
 ...
 * tables drive {@link NodeReader} in reverse. The dictionary contents are
...
public final class NodeTokens {
     ...
     * offset.
     *
     * <p>Indexed by {@code tag - DICTIONARY_0} so {@link NodeReader} can
     ...
     */
    private NodeTokens(String... values) {
        this.values = values;
     ...
     *
     * <p>A {@code -1} return lets {@link NodeWriter} and {@link NodeSizer}
