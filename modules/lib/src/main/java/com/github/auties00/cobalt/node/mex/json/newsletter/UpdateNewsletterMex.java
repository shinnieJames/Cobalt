...
public sealed interface UpdateNewsletterMex extends MexJsonOperation permits UpdateNewsletterMex.Request, UpdateNewsletterMex.Response {
    ...
    /**
     * The request variant of {@link UpdateNewsletterMex} that serialises the
     * mutation variables and emits the outbound IQ stanza.
     *
     * @implNote WAWebMexUpdateNewsletterJob.mexUpdateNewsletter: adapts the {@code variables}
    ...
    /**
     * The response variant of {@link UpdateNewsletterMex} that exposes the data
     * returned by the server after a successful mutation.
     *
     * @implNote WAWebMexUpdateNewsletterJob: adapts the JSON root returned by the GraphQL
    ...
    final class Response implements UpdateNewsletterMex {
         ...
         *
         * @implNote WAWebMexUpdateNewsletterJob.mexUpdateNewsletter: WA Web relies on the
         ...
         * {@code <result>} child.
         *
         * @implNote WAWebMexUpdateNewsletterJob.mexUpdateNewsletter: mirrors the implicit
         * unwrapping that WA Web performs on the GraphQL response,
         * extracting the {@code xwa2_newsletter_update} root.
