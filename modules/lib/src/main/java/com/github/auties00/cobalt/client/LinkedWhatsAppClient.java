...
final class LinkedWhatsAppClient implements WhatsAppClient {
    /**
     ...
     */
    LinkedWhatsAppClient(WhatsAppStore store, WhatsAppClientVerificationHandler.Web webVerificationHandler, WhatsAppClientErrorHandler errorHandler) {
        ...
        this.webAppStateService = new WebAppStateService(this, abPropsService, lidMigrationService, snapshotRecoveryService, wamService);
        ...
        this.socketStream = new SocketStream(this, callService, webVerificationHandler, lidMigrationService, inactiveGroupLidMigrationService, messageService, abPropsService, deviceService, wamService, snapshotRecoveryService, webAppStateService, companionPairingService);
            ...
            try {
                ...
                socketClient.connect(new WhatsAppSocketListener() {
                    ...
                    public void onNode(Node node) {
                        LinkedWhatsAppClient.this.onNode(node);
                    }
    ...
    private void flushDirtyCollectionsWithTimeout() {
        ...
        if (flushThread.isAlive()) {
            ...
            System.getLogger(LinkedWhatsAppClient.class.getName())
    ...
    public Optional<BusinessProfile> queryBusinessProfile(JidProvider contact) {
        ...
        return switch (IqQueryBusinessProfileResponse.of(response, requestBuilder.build()).orElse(null)) {
            case IqQueryBusinessProfileResponse.Success success -> success.profiles()
                    .stream()
                    .findFirst()
                    .map(LinkedWhatsAppClient::toBusinessProfile);
    ...
    private static BusinessProfile toBusinessProfile(IqQueryBusinessProfileResponse.Success.Profile profile) {
        ...
        var hours = profile.businessHours()
                .map(LinkedWhatsAppClient::toBusinessHours)
                .orElse(null);
    ...
    public void editBusinessProfile(BusinessProfile profile) {
        ...
        // WAWebBusinessProfileJob.editBusinessProfile: an empty websites list emits a single empty <website/>
        ...
        var businessHours = profile.hours()
                .map(LinkedWhatsAppClient::toEditBusinessHours)
                .orElse(null);
    ...
    public List<BusinessMerchantCompliance> queryMerchantCompliance(List<? extends JidProvider> jids) {
        ...
        return switch (IqGetMerchantComplianceResponse.of(response, requestBuilder.build()).orElse(null)) {
            case IqGetMerchantComplianceResponse.Success success -> success.entries()
                    .stream()
                    .map(LinkedWhatsAppClient::toBusinessMerchantCompliance)
                    .toList();
    ...
    public Optional<QuickReply> editQuickReply(QuickReplyEdit edit) {
        ...
        var timestamp = Instant.now();
        int currentCount = existing.get().count(); // WAWebQuickRepliesSync.applyMutations: s.count || 0
    ...
    private BotProfile parseBotProfile(Jid botJid, Node profile) {
        ...
        var prompts = profile.streamChild("prompts")
                ...
                .map(LinkedWhatsAppClient::parseBotPrompt)
                .toList();
        ...
        var commands = profile.streamChild("commands")
                ...
                .map(LinkedWhatsAppClient::parseBotCommand)
                .toList();
    ...
    public AckResult sendScheduledCall(JidProvider chatProvider, String title, Instant scheduledAt, boolean video) {
        ...
        var creation = new ScheduledCallCreationMessageBuilder()
                ...
                .title(title)
                .build();
        return sendMessage(chat, MessageContainer.of(creation));
    }
    ...
    public AckResult cancelScheduledCall(MessageKey creationKey) {
        ...
        var edit = new ScheduledCallEditMessageBuilder()
                ...
                .build();
        return sendMessage(chat, MessageContainer.of(edit));
    }
    ...
    public Optional<String> queryName(JidProvider jidProvider) {
        ...
        // WAWebUsync.USyncQuery: contact protocol with the phone-number addressing produces a
    ...
    public Optional<NewsletterLinkPreview> queryNewsletterLinkPreview(String url) {
        ...
        return FetchPlaintextLinkPreviewMexResponse.of(response)
                .map(parsed -> new NewsletterLinkPreviewBuilder()
                        ...
                        .thumbnailWidth(parsed.width().map(LinkedWhatsAppClient::parseIntegerOrNull).orElse(null))
                        .thumbnailHeight(parsed.height().map(LinkedWhatsAppClient::parseIntegerOrNull).orElse(null))
                        .build());
    }
    ...
    public Optional<String> queryAbout(JidProvider jidProvider) {
        var jid = Objects.requireNonNull(jidProvider, "jid cannot be null").toJid();
        // WAWebContactStatusBridge.getStatus: getABPropConfigValue("mex_usync_about_status")
        //   -> WAWebMexUsersGetAboutStatus.getMexUsersAboutStatus (USync MEX)
        // WAWebGetAboutQueryJob.getAbout: !wid.isLid()
    ...
    public Map<Jid, ContactTextStatus> queryUserTextStatuses(List<? extends JidProvider> usersProvider) {
        ...
        for (var item : items) {
            // WAWebMexFetchTextStatusListJob.parseTextStatusServerResponse:
    ...
    private Optional<String> queryAboutViaMexGetAbout(Jid user) {
        ...
        // WAWebMexNativeClient.fetchQuery: telemetry-wrapped MEX dispatch
        var response = sendNode(request);
        // WAWebMexFetchAboutStatusJob.mexGetAbout: status = xwa2_users_updates_since[0].updates[0].text
    ...
    public Optional<LidChange> queryLidChangeNotification() {
        ...
        return LidChangeNotificationMexResponse.of(response)
                .map(parsed -> LidChange.of(
                        parsed.oldValue().orElse(null),
                        parsed.newValue().orElse(null)));
    }
        ...
        return switch (IqBizRefreshCartResponse.of(response, requestBuilder.build()).orElse(null)) {
            case IqBizRefreshCartResponse.Success success -> new BusinessRefreshedCartBuilder()
                    ...
                    .products(success.products()
                            .stream()
                            .map(LinkedWhatsAppClient::toBusinessCartProduct)
                            .toList())
                    .build();
    ...
    public SequencedCollection<Jid> queryBlockList() {
        // WASmaxOutBlocklistsGetBlockListRequest.makeGetBlockListRequest — full list (no dhash digest)
        var request = new SmaxGetBlockListRequest(null);
        var response = sendNode(request.toNode());
    ...
    public BlockListResult queryBlockList(String itemDhash) {
        ...
        return switch (parsed) {
            case null -> new BlockListResult.Unchanged();
            case SmaxGetBlockListResponse.SuccessWithMatch _ -> new BlockListResult.Unchanged();
            case SmaxGetBlockListResponse.SuccessWithMismatch v ->
                    new BlockListResult.Updated(extractBlockedJids(v.listItem()), v.listDhash().orElse(null));
            ...
            case SmaxGetBlockListResponse.CAPISuccessWithMismatch v ->
                    new BlockListResult.Updated(extractBlockedJids(v.listItem()), v.listDhash().orElse(null));
            case SmaxGetBlockListResponse.ClientError clientError ->
                    throw new WhatsAppServerRuntimeException("Block-list query rejected: code="
                            + clientError.errorCode() + ", text=" + clientError.errorText().orElse(null));
            case SmaxGetBlockListResponse.ServerError serverError ->
                    throw new WhatsAppServerRuntimeException("Block-list query server error: code="
                            + serverError.errorCode() + ", text=" + serverError.errorText().orElse(null));
        };
    }

    /**
     * Projects the wire-level {@link SmaxGetBlockListResponse.Item}
     * list into the flat list of blocked JIDs surfaced by
     * {@link BlockListResult.Updated}.
     *
     * <p>Items lacking a JID are dropped — they only occur on the
     * sparsely-populated {@code CAPISuccessWithMismatch} and
     * {@code ForceMigratedSuccessWithMismatch} variants. The
     * {@code displayName} and {@code active} per-item fields are also
     * dropped because no current consumer reads them.
     *
     * @param items the wire-level item list; never {@code null}
     * @return an immutable list of blocked JIDs in their original
     *         order; never {@code null}
     */
    private static List<Jid> extractBlockedJids(List<SmaxGetBlockListResponse.Item> items) {
        return items.stream()
    ...
    public OptOutListResult queryOptOutList(String itemDhash, String iqCategory) {
        ...
        return switch (parsed) {
            case null -> new OptOutListResult.Unchanged();
            case SmaxGetOptOutListResponse.SuccessWithMatch _ -> new OptOutListResult.Unchanged();
            case SmaxGetOptOutListResponse.SuccessWithMismatch v ->
                    new OptOutListResult.Updated(toOptOutEntries(v.listItem()), v.listDhash().orElse(null));
    ...
    private static List<OptOutEntry> toOptOutEntries(List<SmaxGetOptOutListResponse.Item> items) {
        return items.stream()
                .map(LinkedWhatsAppClient::toOptOutEntry)
                .toList();
    }
    ...
    public ContactBlacklistResult queryContactBlacklist(String categoryName,
                                                        ContactBlacklistAddressingMode addressingMode) {
        ...
        return switch (parsed) {
            ...
            case SmaxGetContactBlacklistResponse.SuccessLID successLid -> {
                ...
                var jids = successLid.users().stream()
                        ...
                        .flatMap(Optional::stream)
                        .toList();
                yield new ContactBlacklistResult.Updated(jids, dhash, ContactBlacklistAddressingMode.LID);
            }
    ...
    public void editAbout(String aboutText) {
        ...
        // WAWebSetAboutJob.setAbout: wap("iq",{xmlns:"status",type:"set",...},wap("status",null,text))
    ...
    public void removeProfilePicture() {
        var selfJid = store.jid() // WAWebUserPrefsMeUser.getMeUser
                .map(Jid::withoutData)
                .orElseThrow(() -> new IllegalStateException("Missing self JID"));
        // WAWebSendProfilePictureJob.default: a=null -> no picture body
    ...
    public void pinChat(JidProvider chatProvider, boolean pin) {
        ...
        webAppStateService.pushPatches(PinAction.COLLECTION_NAME, mutations); // WAWebChatPinBridge.setPin: lockForSync(["chat"], i, ...)
    ...
    private void pushMarkChatAsReadMutation(Jid chat, boolean read) {
        ...
        webAppStateService.pushPatches(MarkChatAsReadAction.COLLECTION_NAME, List.of(mutation)); // WAWebChatSeenBridge.sendConversationSeen: lockForMessageRangeSync([], [l], ...)
    ...
    public Optional<Chat> deleteChat(JidProvider chatProvider) {
        ...
        var messageRange = buildOutgoingMessageRange(chatModel); // WAWebDeleteChatSync.getDeleteChatMutation: constructForwardMovingMessageRange
    ...
    public String createLabel(String name, int colorIndex) {
        ...
        var predefinedLabelId = BusinessLabelConstants.mapLabelNameToPredefinedId(name)
                ...
                .findFirst()
                .orElse(null);
        var mutation = labelEditMutationFactory.getLabelMutation( // WAWebBizLabelEditingAction.labelAddAction: getLabelMutation(String(i), t, a, false, c, d, m, l)
                labelId,
                name,
                colorIndex,
    ...
    public Optional<Label> editLabel(String labelId, String name, int colorIndex) {
        ...
        var type = existing.type().orElse(null); // WAWebBizLabelEditingAction.labelEditAction: u (existing type preserved)
        var isActive = existing.isActive().orElse(Boolean.FALSE); // WAWebBizLabelEditingAction.labelEditAction: l (existing active flag)
        var mutation = labelEditMutationFactory.getLabelMutation( // WAWebBizLabelEditingAction.labelEditAction: getLabelMutation(e, t, i, false, a, l, u, d)
                labelId,
                name,
                colorIndex,
        ...
        webAppStateService.pushPatches(LabelEditAction.COLLECTION_NAME, List.of(mutation)); // WAWebSyncdCoreApi.lockForSync(["label"], [p], ...)
        var renamed = !name.equals(existing.name()); // WAWebListsActions.editListAction: l = n.name !== a
        existing.setName(name); // WAWebBizLabelEditingAction.labelEditAction: LabelCollection.add(..., {merge: true})
        ...
        if (renamed) {
            ...
            if (listIdNumber != null) {
                ...
                var wamListType = mapWamListType(existing.type().orElse(null)); // WAWebListsLogging.logListUpdate: f = getListType(_.type); f != null && (u.listType = f)
                if (wamListType != null) {
                    builder.listType(wamListType);
                }
                if (existing.predefinedId().isPresent()) { // WAWebListsLogging.logListUpdate: _.predefinedId != null && (u.predefinedId = _.predefinedId)
    ...
    public Optional<Label> deleteLabel(String labelId) {
        ...
        mutations.add(labelEditMutationFactory.getLabelMutation( // WAWebBizLabelEditingAction.labelDeleteAction: getLabelMutation(e, t, a, true, m, undefined, undefined, l)
                labelId,
                existing.name(), // WAWebBizLabelEditingAction.labelDeleteAction: t (existing display name)
                existing.color(), // WAWebBizLabelEditingAction.labelDeleteAction: a (existing colour index)
    ...
    public void assignChatToAgent(JidProvider chatProvider, String agentId) {
        ...
        var existingAssignment = store.findChatAssignment(chat).orElse(null); // WAWebBizChatAssignmentAction.changeChatAssignment: i[r] = e.chat.assignedAgent != null
        ...
        if (agentId.isEmpty()) {
            store.removeChatAssignment(chat); // WAWebChatAssignmentSync.applyMutations: empty agentId drops the assignment
        } else {
            store.putChatAssignment(new ChatAssignmentBuilder() // WAWebChatAssignmentSync.applyMutations: i.push({...chatId, agentId})
                    .chatJid(chat)
                    .agentId(agentId)
    ...
    public void editChatAssignmentOpenedStatus(JidProvider chatProvider, boolean opened) {
        var chat = Objects.requireNonNull(chatProvider, "chat cannot be null").toJid();
        var existing = store.findChatAssignment(chat).orElse(null); // WAWebBizChatAssignmentOpenedAction.markChatAsOpened: agentId = ChatAssignmentCollection.getCurrentAgentId(e)
        ...
        store.putChatAssignment(new ChatAssignmentBuilder() // ADAPTED: WAWebBizChatAssignmentOpenedAction.updateLocalOpenedState — Cobalt updates the unified ChatAssignment record's opened flag
                .chatJid(chat)
                .agentId(agentId)
                .opened(opened)
                .build());
    ...
    public void editEphemeralTimer(JidProvider chatProvider, ChatEphemeralTimer timer) {
        ...
        if (chat.hasGroupOrCommunityServer()) { // WAWebChangeEphemeralDurationChatAction.changeEphemeralDuration: getIsGroup(e) branch
            ...
            var request = new SmaxGroupsSetPropertyRequest( // WASmaxOutGroupsSetPropertyRequest.makeSetPropertyRequestEphemeral / makeSetPropertyRequestNotEphemeral
                    chat,
                    false, // locked
                    false, // announcement
            ...
            // The typed IqSetDisappearingModeRequest always targets S_WHATSAPP_NET (global default), so we build the chat-addressed IQ inline and validate the relay reply by checking for the canonical <error> child.
            ...
            var response = sendNode(iqNode); // WAWebSetDisappearingModeJob.setDisappearingMode: deprecatedSendIq(r, s)
    ...
    public TosNotices queryTosNotices(Collection<String> noticeIds) {
        ...
        return switch (parsed) {
            // WAWebTosJob.tosNotices: r.refresh + per-notice {id, state}
    ...
    public void cancelGdprRequest(GdprReportType reportType) {
        ...
        switch (parsed) {
            // WAWebDebugGDPR.cancelGDPRRequest: deprecatedSendIq(n, GdprStatusWapParser) — fire-and-forget on success
    ...
    public Optional<ReachoutTimelock> queryReachoutTimelock() {
        ...
        return FetchReachoutTimelockMexResponse.of(response)
                .map(parsed -> ReachoutTimelock.of(
                        parsed.isActive(),
                        parsed.timeEnforcementEnds().orElse(null),
                        parsed.enforcementType().orElse(null)));
    }
    ...
    public Optional<UserIntegritySignals> queryUserIntegritySignals(JidProvider userJidProvider) {
        ...
        return FetchIntegritySignalsMexResponse.of(response)
                .map(parsed -> UserIntegritySignals.of(
                        parsed.isNewAccount().orElse(null),
                        parsed.isSuspicious().orElse(null)));
    }
    ...
    public Optional<NewChatMessageCappingInfo> queryNewChatMessageCappingInfo() {
        ...
        return FetchNewChatMessageCappingInfoMexResponse.of(response)
                .map(parsed -> NewChatMessageCappingInfo.of(
                        parsed.totalQuota().orElse(null),
                        parsed.usedQuota().orElse(null),
                        parsed.cycleStartTimestamp().orElse(null),
                        parsed.cycleEndTimestamp().orElse(null),
                        parsed.serverSentTimestamp().orElse(null),
                        parsed.oteStatus().orElse(null),
                        parsed.mvStatus().orElse(null),
                        parsed.cappingStatus().orElse(null)));
    }
    ...
    public void leaveCommunity(JidProvider communityProvider) {
        ...
        var requestNode = request.toNode();
        var response = sendNode(requestNode); // WAWebGroupExitJob.leaveCommunities: deprecatedSendIq(i, u)
    ...
    public void sendBotWelcomeRequest(JidProvider botJidProvider) {
        ...
        var mutation = botWelcomeRequestMutationFactory.getBotWelcomeRequestSetMutation(botJid, true); // WAWebBotWelcomeRequestSync.getBotWelcomeRequestSetMutation: isSent = true
    ...
    public void editPaymentsTosV3Acceptance(int acceptPayTosVersion, PaymentsTosV3ConsumerVariant variant) {
        ...
        SmaxAccountSetPaymentsTOSv3ConsumerVariant wireVariant = switch (variant) {
    ...
    public BrazilCustomPaymentMethod createBrazilCustomPaymentMethod(BrazilCustomPaymentMethodCreate create) {
        ...
        var metadata = create.metadata().stream()
                .collect(java.util.stream.Collectors.toMap(
                        com.github.auties00.cobalt.model.payment.BrazilCustomPaymentMethodMetadataEntry::key,
                        com.github.auties00.cobalt.model.payment.BrazilCustomPaymentMethodMetadataEntry::value,
                        (a, _) -> a,
    ...
    public NewsletterPublishAck publishNewsletterStatus(JidProvider newsletterJidProvider, NewsletterPublishStatusRequest request) {
        ...
        SmaxStatusPublishPostNewsletterStatusPayload payload = targetServerId != null
    ...
    public List<BusinessProduct> queryBusinessCatalogProducts(JidProvider catalogJidProvider,
        ...
        return switch (IqQueryProductListCatalogResponse.of(response, requestBuilder.build()).orElse(null)) {
            case IqQueryProductListCatalogResponse.Success success -> success.products()
                    .stream()
                    .map(LinkedWhatsAppClient::toBusinessProduct)
                    .toList();
    ...
    private static BusinessProduct toBusinessProduct(IqQueryProductListCatalogResponse.Success.Product product) {
        ...
        var compliance = product.complianceInfo()
                .map(LinkedWhatsAppClient::toBusinessProductCompliance)
                .orElse(null);
    ...
    public MediaConnection queryMediaConns() {
        ...
        return switch (IqQueryMediaConnsResponse.of(response, requestBuilder.build()).orElse(null)) {
            case IqQueryMediaConnsResponse.Success _ -> MediaConnection.of(response);
    ...
    public Map<Jid, IdentityKey> queryIdentityKeys(List<? extends JidProvider> deviceJidsProvider) {
        ...
        return switch (IqGetIdentityKeysResponse.of(response, requestBuilder.build()).orElse(null)) {
            case IqGetIdentityKeysResponse.Success success -> {
                var resolved = new LinkedHashMap<Jid, IdentityKey>();
                for (var entry : success.entries()) {
                    if (entry instanceof IqGetIdentityKeysResponse.IdentityEntry.Resolved r) {
                        resolved.put(r.deviceJid(),
                                new IdentityKey(r.deviceJid(), r.keyBundleType(), r.identityPublicKey()));
                    }
                }
                yield Collections.unmodifiableMap(resolved);
            }
    ...
    public Optional<GroupMetadata> editGroupMetadata(GroupMetadataEdit edit) {
        ...
        // WAWebChatEphemerality.setEphemeralSetting — restored EPHEMERAL dispatch matching the pre-refactor
        ...
        edit.statusMuted().ifPresent(existing::setStatusMuted); // WAWebUserStatusMuteSync.applyMutations: local mute-flag merge, no network packet
        return Optional.of(existing);
    }
    ...
    private void sendGroupDescriptionIq(Jid group, String body, boolean delete) {
        ...
        if (!delete) { // WAWebGroupModifyInfoJob.setGroupDescription: r != null ? ... : hasDescriptionDeleteTrue:true
    ...
    private void sendMexGroupPropertyUpdate(Jid group, String updateJson) {
        ...
        var response = sendNode(request); // WAWebMexNativeClient.fetchQuery: telemetry-wrapped MEX dispatch
     ...
     */
    private static com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterMessagesDirection toWireMessagesDirection(NewsletterHistoryDirection direction) {
        return switch (direction) {
            case null -> null;
            case NewsletterHistoryDirection.Before b -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterMessagesDirection.Before(b.pivot());
            case NewsletterHistoryDirection.After a -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterMessagesDirection.After(a.pivot());
        };
    }

    private static com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterMessageUpdatesDirection toWireMessageUpdatesDirection(NewsletterHistoryDirection direction) {
        return switch (direction) {
            case null -> null;
            case NewsletterHistoryDirection.Before b -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterMessageUpdatesDirection.Before(b.pivot());
            case NewsletterHistoryDirection.After a -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterMessageUpdatesDirection.After(a.pivot());
        };
    }

    private static com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterStatusesDirection toWireStatusesDirection(NewsletterHistoryDirection direction) {
        return switch (direction) {
            case null -> null;
            case NewsletterHistoryDirection.Before b -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterStatusesDirection.Before(b.pivot());
            case NewsletterHistoryDirection.After a -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterStatusesDirection.After(a.pivot());
        };
    }

    private static com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterStatusUpdatesDirection toWireStatusUpdatesDirection(NewsletterHistoryDirection direction) {
        return switch (direction) {
            case null -> null;
            case NewsletterHistoryDirection.Before b -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterStatusUpdatesDirection.Before(b.pivot());
            case NewsletterHistoryDirection.After a -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterStatusUpdatesDirection.After(a.pivot());
        };
    }
     ...
     */
    private static com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterResponsesFilter toWireResponsesFilter(NewsletterResponsesFilter filter) {
        return switch (filter) {
            case null -> null;
            case NewsletterResponsesFilter.Contacts _ -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterResponsesFilter.Contacts();
            case NewsletterResponsesFilter.Replied _ -> new com.github.auties00.cobalt.node.smax.newsletters.SmaxNewslettersGetNewsletterResponsesFilter.Replied();
        };
    }
    ...
    // wired via editChatState(...) above so no duplicates are added
    ...
    public Optional<SignedAttributionCredential> signAnonymousAttributionCredential(byte[] blindedCredentialElementValue,
        ...
        return switch (parsed) {
            case null -> Optional.empty();
            case SmaxPrivatestatsSignCredentialResponse.Success success -> Optional.of(SignedAttributionCredential.of(
                    success.signCredentialT(),
                    success.signedCredentialElementValue(),
                    success.acsPublicKeyElementValue(),
                    success.dleqProofCElementValue(),
                    success.dleqProofSElementValue(),
                    success.projectNameElementValue()));
    ...
    //
    // Most methods take a FederatedRsaEncryption value — a four-tuple of
    // (RSA-wrapped key, AES-GCM nonce, ciphertext, tag) representing the
    // encrypted payload envelope. The metadata is kept as a typed value
    // object because all four byte arrays are mandatory and meaningful
    // as a unit; flattening into individual method parameters would make
    ...
    public Optional<FederatedIdentityCertificate> queryFederatedIdentityCertificate(Instant timestamp,
        ...
        return switch (parsed) {
            ...
            case SmaxWaffleGetCertificateResponse.Success success -> Optional.of(new FederatedIdentityCertificateBuilder()
                    ...
                    .encryptionPem(success.encryptionPem().map(LinkedWhatsAppClient::toModelPem).orElse(null))
                    .signaturePem(success.signaturePem().map(LinkedWhatsAppClient::toModelPem).orElse(null))
                    .passwordPem(success.passwordPem().map(LinkedWhatsAppClient::toModelPem).orElse(null))
                    .build());
