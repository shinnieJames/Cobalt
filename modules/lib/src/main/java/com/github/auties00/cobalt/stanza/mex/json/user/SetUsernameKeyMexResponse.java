 ...
 *
 * <p>Consumed after dispatching {@link SetUsernameKeyMexRequest}. The reply wraps the
 * {@code xwa2_username_pin_set.result} status token; the success signal is the boolean derived from
...
public final class SetUsernameKeyMexResponse implements MexStanza.Response.Json {
    /**
     ...
     * {@link SetUsernameKeyMexRequest#toStanza()}.
     *
    ...
    public static Optional<SetUsernameKeyMexResponse> of(Stanza stanza) {
     ...
     *
     * <p>The result is {@code true} only when the relay's {@code xwa2_username_pin_set.result} token
     ...
     *
     * @implNote This implementation projects {@code data.xwa2_username_pin_set.result}; missing
