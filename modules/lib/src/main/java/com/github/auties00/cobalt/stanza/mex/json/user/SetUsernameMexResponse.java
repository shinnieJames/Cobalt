...
public final class SetUsernameMexResponse implements MexStanza.Response.Json {
    /**
     ...
     * {@link SetUsernameMexRequest#toStanza()}.
     *
    ...
    public static Optional<SetUsernameMexResponse> of(Stanza stanza) {
