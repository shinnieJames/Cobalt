...
public final class SmaxBugReportingReportBugMediaUpload {
    ...
    /**
     * Builds the {@code <media iv cipherKey type? fileName?>{bytes}</media>} child node.
     *
     ...
     * non-{@code null}. {@link SmaxBugReportingReportBugRequest#toNode()} appends the result as
