 ...
 * handshake runs; the tunnel client opens the socket and only then hands
 * it to the WhatsApp protocol layer.
 *
...
public sealed interface WhatsAppProxy {
     ...
     * support see {@link #ofHttp(String, int, WhatsAppProxyAuthenticator.Http)}.
     *
