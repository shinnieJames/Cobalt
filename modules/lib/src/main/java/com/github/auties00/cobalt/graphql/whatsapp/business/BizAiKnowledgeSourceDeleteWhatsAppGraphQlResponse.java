...
/**
 * Parses the WhatsApp Web GraphQL response of the delete-file-source mutation built by
 * {@link BizAiKnowledgeSourceDeleteWhatsAppGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiKnowledgeSourceDeleteWhatsAppGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeSourceDeleteMutation")
public final class BizAiKnowledgeSourceDeleteWhatsAppGraphQlResponse implements WhatsAppGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiKnowledgeSourceDeleteWhatsAppGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiKnowledgeSourceDeleteWhatsAppGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiKnowledgeSourceDeleteWhatsAppGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(Boolean.TRUE.equals(node.getBoolean("success")))
                .build();
        return Optional.of(new BizAiKnowledgeSourceDeleteWhatsAppGraphQlResponse(result));
    }
