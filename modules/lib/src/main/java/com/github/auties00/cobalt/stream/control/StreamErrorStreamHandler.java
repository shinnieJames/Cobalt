 ...
 *
 * <p>The handler is registered under the {@code "stream:error"} tag inside {@link SocketStream} and classifies the
 ...
 * {@link WhatsAppClient#handleFailure(com.github.auties00.cobalt.exception.WhatsAppException)}, and the configured error
