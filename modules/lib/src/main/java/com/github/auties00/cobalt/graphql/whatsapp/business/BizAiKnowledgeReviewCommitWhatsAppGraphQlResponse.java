 ...
 * {@link BizAiKnowledgeReviewCommitWhatsAppGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiKnowledgeReviewCommitWhatsAppGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeReviewCommitMutation")
public final class BizAiKnowledgeReviewCommitWhatsAppGraphQlResponse implements WhatsAppGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiKnowledgeReviewCommitWhatsAppGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiKnowledgeReviewCommitWhatsAppGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiKnowledgeReviewCommitWhatsAppGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(Boolean.TRUE.equals(node.getBoolean("success")))
                .build();
        return Optional.of(new BizAiKnowledgeReviewCommitWhatsAppGraphQlResponse(result));
    }
