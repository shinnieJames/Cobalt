 ...
 */
public sealed interface SmaxGroupsSetSubjectResponse extends SmaxOperation.Response
    ...
    static Optional<? extends SmaxGroupsSetSubjectResponse> of(Node node, Node request) {
