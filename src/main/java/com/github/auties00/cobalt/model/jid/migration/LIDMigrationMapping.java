...
public final class LIDMigrationMapping {
     ...
     * device.
     *
     * @return an {@code OptionalLong} containing the latest LID if available, or
     *         an empty {@code OptionalLong} if not set
     */
    public OptionalLong latestLid() {
        return latestLid == null ? OptionalLong.empty() : OptionalLong.of(latestLid);
    }
