...
import com.github.auties00.cobalt.socket.client.webSocket.WebSocketClient;
...
public final class WhatsAppSocketClient {
    ...
    private WhatsAppSocketClient(TcpSocketClient TCPSocketClient, WhatsAppStore store) {
    ...
    public static WhatsAppSocketClient newCipheredSocketClient(WhatsAppStore store) {
        ...
        var socketClient = switch (store.clientType()) {
            ...
            case MOBILE -> TcpSocketClient.newSocketClient(proxy);
        };
    ...
    public void connect(WhatsAppSocketListener listener) throws IOException, InterruptedException {
        ...
        try {
            TCPSocketClient.connect(hostname, port, path, new TcpSocketClientListener() {
                @Override
        ...
        TCPSocketClient.sendBinary(ByteBuffer.wrap(message));
    ...
    public synchronized void sendNode(Node node) throws IOException {
        ...
        try {
            ...
            TCPSocketClient.sendBinary(ByteBuffer.wrap(ciphertext)); // Write order is guaranteed
